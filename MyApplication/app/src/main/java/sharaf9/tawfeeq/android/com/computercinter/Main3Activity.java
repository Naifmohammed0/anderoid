...
public class Main3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tr.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Boolean r = mydb.inserData1(name.getText().toString(),phon.getText().toString(),price.getText().toString());
        ...
        t.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Boolean up = mydb.updateData1(Id.getText().toString(),name.getText().toString(),phon.getText().toString(),price.getText().toString());
                if (up==true) {
        ...
        de.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Integer del = mydb.Delete1 (Id.getText().toString());
                if (del > 0) {
    ...
    public void showdate(){
        ...
        ArrayList listData = mydb.get_first_name1();
